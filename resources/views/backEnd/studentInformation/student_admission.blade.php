                        ...
                        <div class="">
                            ...
                            <div class="row mb-40 mt-30">
                                <div class="col-lg-2">
                                    <div class="input-effect sm2_mb_20 md_mb_20">
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('session') ? ' is-invalid' : '' }}"
                                                name="session" id="academic_year">
                                            <option data-display="@lang('common.academic_year') @if(is_required('session')==true) * @endif"
                                                    value="">@lang('common.academic_year') @if(is_required('session')==true)
                                                    *
                                                @endif</option>
                                            @foreach($sessions as $session)
                                                <option value="{{$session->id}}" {{old('session', getAcademicId()) == $session->id? 'selected': ''}}>{{$session->year}}
                                                    [{{$session->title}}]
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-lg-3">
                                    <div class="input-effect sm2_mb_20 md_mb_20" id="class-div">
                                        <select class="niceSelect w-100 bb form-control{{ $errors->has('class') ? ' is-invalid' : '' }}"
                                            ...
                                            <option data-display="@lang('common.class') @if(is_required('class')==true) * @endif"
                                    ...
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20" id="sectionStudentDiv">
                                            <select class="niceSelect w-100 bb form-control {{ $errors->has('section') ? ' is-invalid' : '' }}"
                                                ...
                                                <option data-display="@lang('common.section') @if(is_required('section')==true) * @endif"
                                ...
                                @if(is_show('admission_number'))
                                    <div class="col-lg-2">
                                        <div class="input-effect">
                                            <input class="primary-input  form-control{{ $errors->has('admission_number') ? ' is-invalid' : '' }}"
                                                   type="text" onkeyup="GetAdmin(this.value)" name="admission_number"
                                                   value="{{$max_admission_id != ''? $max_admission_id + 1 : 1}}">

                                            <label>@lang('student.admission_number') @if(is_required('admission_number')==true)
                                                    *
                                                @endif</label>
                                            <span class="focus-border"></span>
                            ...
                            <div class="row mb-40">
                                @if(is_show('first_name'))
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            ...
                                            <label>@lang('student.first_name')  @if(is_required('first_name')==true)
                                                    <span> *</span>
                                                @endif </label>
                                            <span class="focus-border"></span>
                                ...
                                @if(is_show('last_name'))
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            ...
                                            <label>@lang('student.last_name')  @if(is_required('last_name')==true)
                                                    <span> *</span>
                                                @endif</label>
                                            <span class="focus-border"></span>
                                ...
                                @if(is_show('gender'))
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('gender') ? ' is-invalid' : '' }}"
                                                    name="gender">
                                                <option data-display="@lang('common.gender') @if(is_required('gender')==true) * @endif"
                                ...
                                @if(is_show('date_of_birth'))
                                    <div class="col-lg-3">
                                        <div class="no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    <input class="primary-input date form-control{{ $errors->has('date_of_birth') ? ' is-invalid' : '' }}"
                                                           id="startDate" type="text"
                                                           name="date_of_birth" value="{{old('date_of_birth')}}"
                                                           autocomplete="off">

                                                    <label>@lang('common.date_of_birth')  @if(is_required('date_of_birth')==true)
                                                            <span> *</span>
                                                        @endif</label>
                            ...
                            <div class="row mb-40">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('blood_group') ? ' is-invalid' : '' }}"
                                                    name="blood_group">
                                                <option data-display="@lang('common.blood_group') @if(is_required('blood_group')==true)  * @endif"
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <select class="niceSelect w-100 bb form-control{{ $errors->has('religion') ? ' is-invalid' : '' }}"
                                                    name="religion">
                                                <option data-display="@lang('student.religion') @if(is_required('religion')==true) @endif"
                                ...
                                @if(is_show('caste'))
                                    <div class="col-lg-2">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" name="caste"
                                                   value="{{old('caste')}}">
                                            <label>@lang('student.caste') @if(is_required('caste')==true)
                                                    <span> *</span>
                                                @endif</label>
                                            <span class="focus-border"></span>
                                            @if ($errors->has('caste'))
                                    ...
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input oninput="emailCheck(this)"
                                                   class="primary-input email_address form-control{{ $errors->has('email_address') ? ' is-invalid' : '' }}"
                                                   id="email_address" type="text" name="email_address"
                                                   value="{{old('email_address')}}">
                                            <label>@lang('common.email_address')  @if(is_required('email_address')==true)
                                                    <span> *</span>
                                                @endif</label>
                                            <span class="focus-border"></span>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input oninput="phoneCheck(this)"
                                                   class="primary-input phone_number form-control{{ $errors->has('phone_number') ? ' is-invalid' : '' }}"
                                                   type="tel" name="phone_number" id="phone_number"
                                                   value="{{old('phone_number')}}">

                                            <label>@lang('student.phone_number')  @if(is_required('phone_number')==true)
                                                    <span> *</span>
                                                @endif</label>
                                        ...
                                        <div class="no-gutters input-right-icon">
                                            <div class="col">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    ...
                                                    <span class="focus-border">  @if(is_required('admission_date')==true)
                                                            <span> *</span>
                                                        @endif</span>
                                        ...
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <select class="niceSelect w-100 bb form-control{{ $errors->has('student_category_id') ? ' is-invalid' : '' }}"
                                                    ...
                                                    <option data-display="@lang('student.category')  @if(is_required('student_category_id')==true) * @endif"
                                        ...
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <select class="niceSelect w-100 bb form-control{{ $errors->has('student_group_id') ? ' is-invalid' : '' }}"
                                                    ...
                                                    <option data-display="@lang('student.group')  @if(is_required('student_group_id')==true) * @endif"
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" name="height"
                                                   value="{{old('height')}}">
                                            <label>@lang('student.height_in')) @if(is_required('height')==true)
                                                    <span> *</span>
                                                @endif </label>
                                            <span class="focus-border"></span>
                                    ...
                                    <div class="col-lg-2">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" name="weight"
                                                   value="{{old('weight')}}">
                                            <label>@lang('student.weight_kg')  @if(is_required('weight')==true)
                                                    <span> *</span>
                                                @endif </label>
                                            <span class="focus-border"></span>
                            ...
                            @if(moduleStatusCheck('Lead')==true)
                                <div class="row mb-40">
                                    @if(is_show('source_id'))
                                        <div class="col-lg-4 ">
                                            <div class="input-effect">
                                                <select class="niceSelect w-100 bb form-control{{ $errors->has('route') ? ' is-invalid' : '' }}"
                                                        name="source_id" id="source_id">
                                                    <option data-display="@lang('lead::lead.source') @if(is_required('source_id')==true) * @endif"
                                ...
                                <div class="parent_details" id="parent_details">
                                    ...
                                    <div class="row mb-40 mt-30">
                                        @if(is_show('fathers_name'))
                                            <div class="col-lg-3">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    <input class="primary-input form-control{{ $errors->has('fathers_name') ? ' is-invalid' : '' }}"
                                                           type="text" name="fathers_name" id="fathers_name"
                                                           value="{{old('fathers_name')}}">
                                                    <label>@lang('student.father_name')  @if(is_required('father_name')==true)
                                                            <span> *</span>
                                                        @endif </label>
                                                    <span class="focus-border"></span>
                                        ...
                                        @if(is_show('fathers_occupation'))
                                            <div class="col-lg-3">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    ...
                                                    <label>@lang('student.occupation') @if(is_required('fathers_occupation')==true)
                                                            <span> *</span>
                                                        @endif</label>
                                                    <span class="focus-border"></span>
                                        ...
                                        @if(is_show('fathers_phone'))
                                            <div class="col-lg-3">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    ...
                                                    <label>@lang('student.father_phone')  @if(is_required('father_phone')==true)
                                                            <span> *</span>
                                                        @endif</label>
                                                    <span class="focus-border"></span>
                                                    ...
                                                    <div class="col">
                                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                                            <input class="primary-input" type="text"
                                                                   ...
                                                                   placeholder="@lang('common.photo') @if(is_required('fathers_photo')==true) * @endif"
                                                                   readonly="">
                                                            <span class="focus-border"></span>
                                    ...
                                    <div class="row mb-30">
                                        @if(is_show('mothers_name'))
                                            <div class="col-lg-3">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    <input class="primary-input form-control{{ $errors->has('mothers_name') ? ' is-invalid' : '' }}"
                                                           type="text" name="mothers_name" id="mothers_name"
                                                           value="{{old('mothers_name')}}">
                                                    <label>@lang('student.mother_name')  @if(is_required('mothers_name')==true)
                                                            <span> *</span>
                                                        @endif </label>
                                                    <span class="focus-border"></span>
                                        ...
                                        @if(is_show('mothers_occupation'))
                                            <div class="col-lg-3">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    ...
                                                    <label>@lang('student.occupation') @if(is_required('mothers_occupation')==true)
                                                            <span> *</span>
                                                        @endif</label>
                                                    <span class="focus-border"></span>
                                        ...
                                        @if(is_show('mothers_phone'))
                                            <div class="col-lg-3">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    ...
                                                    <label>@lang('student.mother_phone')  @if(is_required('mothers_phone')==true)
                                                            <span> *</span>
                                                        @endif</label>
                                                    <span class="focus-border"></span>
                                                    ...
                                                    <div class="col">
                                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                                            <input class="primary-input" type="text"
                                                                   ...
                                                                   placeholder="@lang('student.photo')  @if(is_required('mothers_photo')==true) * @endif"
                                                                   readonly="">
                                                            <span class="focus-border"></span>
                                                ...
                                                <div class="d-flex radio-btn-flex ml-40 mt-15">
                                                    <div class="mr-30">
                                                        <input type="radio" name="relationButton" id="relationFather"
                                                               value="F"
                                                               class="common-radio relationButton" {{old('relationButton') == "F"? 'checked': ''}}>
                                                        <label for="relationFather">@lang('student.father')</label>
                                                    </div>
                                                    <div class="mr-30">
                                                        <input type="radio" name="relationButton" id="relationMother"
                                                               value="M"
                                                               class="common-radio relationButton" {{old('relationButton') == "M"? 'checked': ''}}>
                                                        <label for="relationMother">@lang('student.mother')</label>
                                                    </div>
                                                    <div>
                                                        <input type="radio" name="relationButton" id="relationOther"
                                                               value="O"
                                                               class="common-radio relationButton" {{old('relationButton') != ""? (old('relationButton') == "O"? 'checked': ''): 'checked'}}>
                                    ...
                                    <div class="row mb-40">
                                        @if(is_show('guardians_name'))
                                            <div class="col-lg-3">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    <input class="primary-input form-control{{ $errors->has('guardians_name') ? ' is-invalid' : '' }}"
                                                           type="text" name="guardians_name" id="guardians_name"
                                                           value="{{old('guardians_name')}}">
                                                    <label>@lang('student.guardian_name')  @if(is_required('guardians_name')==true)
                                                            <span> *</span>
                                                        @endif </label>
                                                    <span class="focus-border"></span>
                                        ...
                                        @if(is_show('guardians_email') || is_show('guardians_phone'))
                                            <div class="col-lg-3">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    <input class="primary-input read-only-input" type="text"
                                                           placeholder="Relation" name="relation" id="relation"
                                                           value="Other" readonly>
                                                    <label>@lang('student.relation_with_guardian') @if(is_required('relation')==true)
                                                            <span> *</span>
                                                        @endif </label>
                                                    <span class="focus-border"></span>
                                        ...
                                        @if(is_show('guardians_email'))
                                            <div class="col-lg-3">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    ...
                                                    <label>@lang('student.guardian_email') @if(is_required('guardians_email')==true)
                                                            <span> *</span>
                                                        @endif</label>
                                                    <span class="focus-border"></span>
                                                    ...
                                                    <div class="col">
                                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                                            <input class="primary-input" type="text"
                                                                   ...
                                                                   placeholder="@lang('student.photo') @if(is_required('guardians_photo')==true) * @endif"
                                                                   readonly="">
                                                            <span class="focus-border"></span>
                                    ...
                                    <div class="row mb-30">
                                        @if(is_show('guardians_phone'))
                                            <div class="col-lg-3">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    <input class="primary-input form-control{{ $errors->has('guardians_phone') ? ' is-invalid' : '' }}"
                                                           type="text" name="guardians_phone" id="guardians_phone"
                                                           value="{{old('guardians_phone')}}">
                                                    <label>@lang('student.guardian_phone')@if(is_required('guardians_phone')==true)
                                                            <span> *</span>
                                                        @endif</label>
                                                    <span class="focus-border"></span>
                                        ...
                                        @if(is_show('guardians_occupation'))
                                            <div class="col-lg-3">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    ...
                                                    <label>@lang('student.guardian_occupation') @if(is_required('guardians_occupation')==true)
                                                            <span> *</span>
                                                        @endif</label>
                                                    <span class="focus-border"></span>
                                        ...
                                        @if(is_show('guardians_address'))
                                            <div class="col-lg-6">
                                                <div class="input-effect sm2_mb_20 md_mb_20">
                                                    ...
                                                    <label>@lang('student.guardian_address') @if(is_required('guardians_address')==true)
                                                            <span> *</span>
                                                        @endif </label>
                                        ...
                                        <div class="col-lg-4 ">
                                            <div class="input-effect" style="margin-top:53px !important">
                                                <select class="niceSelect w-100 bb form-control{{ $errors->has('route') ? ' is-invalid' : '' }}"
                                                    ...
                                                    <option data-display="@lang('lead::lead.city') @if(is_required('lead_city')==true) * @endif"
                                ...
                                @if(is_show('current_address'))
                                    <div class="col-lg-4">
                                        <div class="input-effect sm2_mb_20 md_mb_20 mt-20">
                                            ...
                                            <label>@lang('student.current_address') @if(is_required('current_address')==true)
                                                    <span> *</span>
                                                @endif </label>
                                            <span class="focus-border textarea"></span>
                                ...
                                @if(is_show('permanent_address'))
                                    <div class="col-lg-4">
                                        <div class="input-effect sm2_mb_20 md_mb_20 mt-20">
                                            <textarea
                                                    class="primary-input form-control{{ $errors->has('current_address') ? ' is-invalid' : '' }}"
                                                    cols="0" rows="3" name="permanent_address"
                                                    id="permanent_address">{{old('permanent_address')}}</textarea>
                                            <label>@lang('student.permanent_address')  @if(is_required('permanent_address')==true)
                                                    <span> *</span>
                                                @endif </label>
                                            <span class="focus-border textarea"></span>
                                    ...
                                    @if(is_show('route'))
                                        <div class="col-lg-3">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <select class="niceSelect w-100 bb form-control{{ $errors->has('route') ? ' is-invalid' : '' }}"
                                                        name="route" id="route">
                                                    <option data-display="@lang('student.route_list') @if(is_required('route')==true) * @endif"
                                    ...
                                    @if(is_show('vehicle'))
                                        <div class="col-lg-3">
                                            <div class="input-effect sm2_mb_20 md_mb_20" id="select_vehicle_div">
                                                <select class="niceSelect w-100 bb form-control{{ $errors->has('vehicle') ? ' is-invalid' : '' }}"
                                                        name="vehicle" id="selectVehicle">
                                                    <option data-display="@lang('student.vehicle_number') @if(is_required('vehicle')==true) * @endif"
                            ...
                            @if(isMenuAllowToShow('dormitory'))
                                ...
                                <div class="row mb-40 mt-30">
                                    @if(is_show('dormitory_name'))
                                        <div class="col-lg-3">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <select class="niceSelect w-100 bb form-control{{ $errors->has('dormitory_name') ? ' is-invalid' : '' }}"
                                                        name="dormitory_name" id="SelectDormitory">
                                                    <option data-display="@lang('dormitory.dormitory_name') @if(is_required('dormitory_name')==true) * @endif"
                                    ...
                                    @if(is_show('room_number'))
                                        <div class="col-lg-3">
                                            <div class="input-effect sm2_mb_20 md_mb_20" id="roomNumberDiv">
                                                <select class="niceSelect w-100 bb form-control{{ $errors->has('room_number') ? ' is-invalid' : '' }}"
                                                        name="room_number" id="selectRoomNumber">
                                                    <option data-display="@lang('academics.room_number') @if(is_required('room_number')==true) <span> *</span> @endif"
                            ...
                            <div class="row mb-30 mt-30">
                                @if(is_show('national_id_number'))
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            ...
                                            <label>@lang('common.national_id_number') @if(is_required('national_id_number')==true)
                                                    <span> *</span>
                                                @endif </label>
                                            <span class="focus-border"></span>
                                ...
                                @if(is_show('local_id_number'))
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" name="local_id_number"
                                ...
                                @if(is_show('bank_account_number'))
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" name="bank_account_number"
                                                   value="{{old('bank_account_number')}}">
                                            <label>@lang('accounts.bank_account_number')@if(is_required('bank_account_number')==true)
                                                    <span> *</span>
                                                @endif </label>
                                            <span class="focus-border"></span>
                                ...
                                @if(is_show('bank_name'))
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <input class="primary-input" type="text" name="bank_name"
                                                   value="{{old('bank_name')}}">
                                            <label>@lang('student.bank_name') @if(is_required('bank_name')==true)
                                                    <span> *</span>
                                                @endif </label>
                                            <span class="focus-border"></span>
                            ...
                            <div class="row mb-40">
                                @if(is_show('previous_school_details'))
                                    <div class="col-lg-6">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            <textarea class="primary-input form-control" cols="0" rows="3"
                                                      name="previous_school_details">{{old('previous_school_details')}}</textarea>
                                            <label>@lang('student.previous_school_details')@if(is_required('previous_school_details')==true)
                                                    <span> *</span>
                                                @endif</label>
                                            <span class="focus-border textarea"></span>
                                ...
                                @if(is_show('additional_notes'))
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            ...
                                            <label>@lang('student.additional_notes') @if(is_required('additional_notes')==true)
                                                    <span> *</span>
                                                @endif</label>
                                            <span class="focus-border textarea"></span>
                                    ...
                                    <div class="col-lg-3">
                                        <div class="input-effect mt-30">
                                            <input class="primary-input form-control" type="text" name="ifsc_code"
                                                   value="{{old('ifsc_code')}}">
                                            <label>@lang('student.ifsc_code') @if(is_required('ifsc_code')==true)
                                                    <span> *</span>
                                                @endif</label>
                                            <span class="focus-border"></span>
                                ...
                                @if(is_show('document_file_1'))
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            ...
                                            <label>@lang('student.document_01_title') @if(is_required('document_file_1')==true)
                                                    <span> *</span>
                                                @endif</label>
                                            <span class="focus-border"></span>
                                ...
                                @if(is_show('document_file_2'))
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            ...
                                            <label>@lang('student.document_02_title') @if(is_required('document_file_2')==true)
                                                    <span> *</span>
                                                @endif</label>
                                            <span class="focus-border"></span>
                                ...
                                @if(is_show('document_file_3'))
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            ...
                                            <label>@lang('student.document_03_title') @if(is_required('document_file_3')==true)
                                                    <span> *</span>
                                                @endif</label>
                                            <span class="focus-border"></span>
                                ...
                                @if(is_show('document_file_4'))
                                    <div class="col-lg-3">
                                        <div class="input-effect sm2_mb_20 md_mb_20">
                                            ...
                                            <label>@lang('student.document_04_title') @if(is_required('document_file_4')==true)
                                                    <span> *</span>
                                                @endif</label>
                                            <span class="focus-border"></span>
                                        ...
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input" type="text" id="placeholderFileTwoName"
                                                       placeholder="02 @if(is_required('document_file_2')==true) * @endif"
                                                       readonly="">
                                                <span class="focus-border"></span>
                                        ...
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input" type="text" id="placeholderFileThreeName"
                                                       placeholder="03 @if(is_required('document_file_3')==true) * @endif"
                                                       readonly="">
                                                <span class="focus-border"></span>
                                        ...
                                        <div class="col">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input class="primary-input" type="text" id="placeholderFileFourName"
                                                       placeholder="04 @if(is_required('document_file_4')==true) * @endif"
                                                       readonly="">
                                                <span class="focus-border"></span>
